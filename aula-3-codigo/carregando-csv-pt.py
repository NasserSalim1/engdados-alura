...
cobranca_pacientes = pd.read_csv(r'D:\Cursos\aws\aula-2-dataset\inpatientCharges.csv')
...
diagnosticos = pd.read_csv(r'D:\Cursos\aws\aula-2-dataset\datasets_180_408_data.csv')
